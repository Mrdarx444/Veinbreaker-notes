...
> 	3) Blue Zones (Up Left/Up Right): movement while Aiming Up (For penetrable platforms or top attack spatially for bosses)
> 	4) Purple Zones (Down Left/Down Right): movement while Aiming Down (For penetrable platforms or air attack)
...
| **Wall Jump**    | `is_on_wall()` &<br>`can_wall_jump` &<br>Press **`Jump`** &<br>Is on Wall Slide State<br> | `is_on_floor()` \|\| <br>`is_on_wall()`                     | [[Skill Tree System]]<br>(With WallSlide) | The [[Player]] Can Jump off the walls to overcome obstacles or to solve puzzles               |
...
| **Forced Fall**  | Press `Jump`+<br>`Joystick Down` simultaneously while [[Player]] In the Air               | Allways                                                     | [[Skill Tree System]]                     | The [[Player]] will Fall Fast In The Jump State"                                              |
